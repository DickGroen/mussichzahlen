...
Du gibst KEINE endgülta// prompts/vertrag/triage.js
...
1. Dokumenttyp wie beschrieben in der ursprünglichen Prompt-Spezifikation.
...
- possible_kuendigung_blockiert: Kündigung erschwert, abgelehnt oder unklar.
- possible_widerrufsrecht: mögliches Widerrufsrecht nicht klar dargestellt.
- possible_unklare_laufzeit: Laufzeit, Verlängerung oder Vertragsende unklar.
- possible_unklare_kuendigungsfrist: Kündigungsfrist, -weg oder -form unklar.
Nur true wenn konkrete Hinweise im Dokument. Im Zweifel: null.

5. Risk
- high: blockierte Kündigung, problematische Verlängerungsklausel, flagCount >= 4.
- medium: einzelne prüfenswerte Punkte, flagCount 2–3.
- low: überwiegend nachvollziehbar, flagCount 0–1.
- annual_cost > 500 und flagCount >= 2 → normalerweise high.

6. Tier
- tier1: flagCount >= 4, blockierte Kündigung, hohe Kosten mit unklarer Kündigung.
- tier2: flagCount 1–3, moderate Unklarheiten.
- tier3: flagCount 0, überwiegend nachvollziehbar.

7. Chance
- Blockierte Kündigung: 70–90. Problematische Verlängerung: 65–85.
- Preiserhöhung mit Sonderkündigung: 60–85. Unklare Kündigung: 50–75.
...
GUT (Einordnungsform): "Das Schreiben informiert über eine Preiserhöhung von 39,90 EUR auf 49,90 EUR — ein Hinweis auf ein Sonderkündigungsrecht fehlt."
GUT (Kontrastform): "Das Unternehmen teilt eine Preiserhöhung mit und schreibt, dass kein Sonderkündigungsrecht besteht — ob das zutrifft, hängt von den Umständen ab."
...
NUR JSON zurückgeben. Keine Erklärung. Kein Markdown.`;- Erfinde keine Vertragsdaten, Laufzeiten, Kündigungsfristen, Preise oder Klauseln.
- Behaupte nie, dass eine Klausel sicher unwirksam ist.
