...
<div style="font-family:Arial,sans-serif;">
  ...
  <p><strong>Tier:</strong> ${escapeHtml(String(triage?.tier || "unbekannt"))}</p>
</div>`
  });
}
...
<div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;color:#1f2937;line-height:1.7;">
  ...
  <p>
    Das Schreiben wirkt nach erster Einschätzung derzeit eher nachvollziehbar.
  </p>

  <p>
    Aktuell bestehen keine deutlichen Hinweise auf größere Unstimmigkeiten oder ungewöhnliche Zusatzkosten.
  </p>

  <div style="background:#f9fafb;padding:16px;border-radius:8px;margin:24px 0;">
    <table style="width:100%;border-collapse:collapse;font-size:14px;">
      <tr>
        <td style="padding:8px 0;font-weight:bold;width:140px;">Dokument</td>
        <td style="padding:8px 0;">${escapeHtml(labels.title)}</td>
      </tr>
      <tr>
        <td style="padding:8px 0;font-weight:bold;">Absender</td>
        <td style="padding:8px 0;">${escapeHtml(triage?.sender || "unbekannt")}</td>
      </tr>
      <tr>
        <td style="padding:8px 0;font-weight:bold;">Betrag</td>
        <td style="padding:8px 0;">${escapeHtml(amount)}</td>
      </tr>
      <tr>
        <td style="padding:8px 0;font-weight:bold;">Einschätzung</td>
        <td style="padding:8px 0;">Eher unauffällig</td>
      </tr>
    </table>
  </div>

  <p>
    Eine kostenpflichtige vollständige Analyse scheint auf Basis der ersten Prüfung nicht zwingend notwendig.
  </p>

  <p>
    Falls Sie dennoch zusätzliche Sicherheit wünschen oder später weitere Schreiben erhalten, können Sie jederzeit eine ausführlichere Prüfung anfordern.
  </p>
