...
<div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;color:#1f2937;line-height:1.7;">
  ...
  <p>
    ...
    ${amount !== "unbekannt"
      ...
      : "die Forderung"}
    zahlen,
    kann eine kurze Prüfung sinnvoll sein.
  </p>

  <hr style="border:none;border-top:1px solid #e5e7eb;margin:28px 0;">

  <p>
    <strong>Die vollständige Analyse beinhaltet:</strong>
  </p>
...
<div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;color:#1f2937;line-height:1.7;">
  ...
  <table style="width:100%;border-collapse:collapse;margin:20px 0;border:1px solid #e5e7eb;">
    ...
    <tr>
      ...
      <td style="padding:10px;">
        ${escapeHtml(riskLabel(triage?.risk))}
      </td>
    </tr>
...
export async function sendPaidEmail(env, {
  ...
  await sendEmail(env, {
    ...
    subject:
      `Ihre Analyse ist fertig — ${labels.title} | MussIchZahlen`,
